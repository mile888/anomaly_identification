...
% % % % % % % All meas Full Redundancy
%%% the value is not important here, because we just use the From and To
%%% bus to find out the place of measurements
            %         |Msnt |Type | Value | From | To | Rii | 
zdata14   = [ %---- Voltage Magnitude ------------%
            ...
            8     1   -0.0610   8       0   1e-4; 
            9     1   -0.1490   9       0   1e-4;
            10    1   -0.1490   10      0   1e-4;
            11    1   -0.1490   11      0   1e-4;
            12    1   -0.1490   12      0   1e-4;
            13    1   -0.1490   13      0   1e-4;
            14    1   -0.1490   14      0   1e-4;
            %-----------------------------------%
            %---- Real Power Injection ---------%
           15     2    0.3523   2       0   1e-4;
           16     2    0.0876   3       0   1e-4; 
           17     2    0.00     4       0   1e-4;
           18     2    0.2103   5       0   1e-4;
           19     2    0.2103   6       0   1e-4;
           20     2    0.2103   7       0   1e-4;
           21     2    0.2103   8       0   1e-4;
           22     2    0.2103   9       0   1e-4;
           23     2   -0.0580  10       0   1e-4;
           24     2   -0.0180  11       0   1e-4;
           25     2   -0.0160  12       0   1e-4; 
           26     2   -0.0160  13       0   1e-4; 
           27     2   -0.0500  14       0   1e-4;
           %------------------------------------%
           %---- Reative Power Injection -------%
           28     3    0.3523   2       0   1e-4;
           29     3    0.0876   3       0   1e-4; 
           30     3    0.00     4       0   1e-4;
           31     3    0.2103   5       0   1e-4;
           32     3    0.2103   6       0   1e-4;
           33     3    0.2103   7       0   1e-4;
           34     3    0.2103   8       0   1e-4;
           35     3    0.2103   9       0   1e-4;
           36     3   -0.0580  10       0   1e-4;
           37     3   -0.0180  11       0   1e-4;
           38     3   -0.0160  12       0   1e-4; 
           39     3   -0.0160  13       0   1e-4; 
           40     3   -0.0500  14       0   1e-4;
           %------------------------------------%
           %------ Real Power Flow ------------- %
           41     4    1.5708   1       2   64e-6;
           42     4    0.2707   1       5   64e-6;
           43     4    0.7340   2       3   64e-6;
           44     4    0.2707   3       4   64e-6;
           45     4   -0.5427   4       2   64e-6;
           46     4    0.2707   4       7   64e-6;
           47     4    0.1546   4       9   64e-6;
           48     4   -0.4081   5       2   64e-6;
           49     4    0.6006   5       4   64e-6;
           50     4    0.4589   5       6   64e-6;
           51     4    0.1834   6      13   64e-6;
           52     4    0.2707   7       8   64e-6;
           53     4    0.2707   7       9   64e-6;
           54     4    0.2707   9      10   64e-6;
           55     4    0.2707   9      14   64e-6;
           56     4   -0.0816  11       6   64e-6;
           57     4   -0.0816  11      10   64e-6;
           58     4   -0.0816  12       6   64e-6;
           59     4    0.0188  12      13   64e-6;
           60     4   -0.0816  13      14   64e-6;
           %------------------------------------%
           %------ Reactive Power Flow -------- %
           61     5    1.5708   1       2   64e-6;
           62     5    0.2707   1       5   64e-6;
           63     5    0.7340   2       3   64e-6;
           64     5    0.2707   3       4   64e-6;
           65     5   -0.5427   4       2   64e-6;
           66     5    0.2707   4       7   64e-6;
           67     5    0.1546   4       9   64e-6;
           68     5   -0.4081   5       2   64e-6;
           69     5    0.6006   5       4   64e-6;
           60     5    0.4589   5       6   64e-6;
           71     5    0.1834   6      13   64e-6;
           72     5    0.2707   7       8   64e-6;
           73     5    0.2707   7       9   64e-6;
           74     5    0.2707   9      10   64e-6;
           75     5    0.2707   9      14   64e-6;
           76     5   -0.0816  11       6   64e-6;
           77     5   -0.0816  11      10   64e-6;
           78     5   -0.0816  12       6   64e-6;
           79     5    0.0188  12      13   64e-6;
           80     5   -0.0816  13      14   64e-6;];
           %--------------------------------------%
            
% % % % % %  Power injection full redundancy            
% %         |Msnt |Type | Value | From | To | Rii | 
% zdata14   = [ %---- Voltage Magnitude ------------%
%             1     1    1.06     1       0   9e-4;
%             %-----------------------------------%
...
%             8     2   -0.0610   8       0   1e-4; 
%             9     2   -0.1490   9       0   1e-4;
%             10    2   -0.1490   10      0   1e-4;
%             11    2   -0.1490   11      0   1e-4;
%             12    2   -0.1490   12      0   1e-4;
%             13    2   -0.1490   13      0   1e-4;
%             14    2   -0.1490   14      0   1e-4;
%            %------------------------------------%
%            %---- Reative Power Injection -------%
%            15     3    0.3523   2       0   1e-4;
%            16     3    0.0876   3       0   1e-4; 
%            17     3    0.00     4       0   1e-4;
%            18     3    0.2103   5       0   1e-4;
%            19     3    0.2103   6       0   1e-4;
%            20     3    0.2103   7       0   1e-4;
%            21     3    0.2103   8       0   1e-4;
%            22     3    0.2103   9       0   1e-4;
%            23     3   -0.0580  10       0   1e-4;
%            24     3   -0.0180  11       0   1e-4;
%            25     3   -0.0160  12       0   1e-4; 
%            26     3   -0.0160  13       0   1e-4; 
%            27     3   -0.0500  14       0   1e-4;
%            %------------------------------------%
%            %------ Real Power Flow ------------- %
%            28     4    1.5708   1       2   64e-6;
%            29     4    0.7340   2       3   64e-6;
%            30     4   -0.5427   4       2   64e-6;
%            31     4    0.2707   4       7   64e-6;
%            32     4    0.1546   4       9   64e-6;
%            33     4   -0.4081   5       2   64e-6;
%            34     4    0.6006   5       4   64e-6;
%            35     4    0.4589   5       6   64e-6;
%            36     4    0.1834   6      13   64e-6;
%            37     4    0.2707   7       9   64e-6;
%            38     4   -0.0816  11       6   64e-6;
%            39     4    0.0188  12      13   64e-6;
%            %------------------------------------%
%            %------ Reactive Power Flow -------- %
%            40     5   -0.1748   1       2   64e-6;
%            41     5    0.0594   2       3   64e-6;
%            42     5    0.0213   4       2   64e-6;
%            43     5   -0.1540   4       7   64e-6;
%            44     5   -0.0264   4       9   64e-6;
%            45     5   -0.0193   5       2   64e-6;
%            46     5   -0.1006   5       4   64e-6;
%            47     5   -0.2084   5       6   64e-6;
%            48     5    0.0998   6      13   64e-6;
%            49     5    0.1480   7       9   64e-6;
%            50     5   -0.0864  11       6   64e-6;
%            51     5    0.0141  12      13   64e-6;];
%            %--------------------------------------%
